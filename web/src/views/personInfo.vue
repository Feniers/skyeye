    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-aside width="300px">
          <el-col :span="12">
            ...
            <div class="demo-basic--circle">
              <div class="img">
                ...
                <!--Element UI库中的<el-avatar>组件来显示一个头像-->
              </div>
              <div class="block">
                <span>ADMIN</span>
              </div>
          ...
          <el-input v-model="input2" type="text" placeholder="用户昵称" show-word-limit></el-input>
          ...
          <el-input v-model="input6" type="text" placeholder="用户权限" maxlength="2" show-word-limit></el-input>
          <el-input v-model="input7" placeholder="邮箱">
            <template slot="append">@163.com</template>
          </el-input>
          <el-input v-model="input8" type="text" placeholder="手机号码" maxlength="20" show-word-limit></el-input>
...
export default {
  ...
  data() {
    return {
      ...
      input9: '',
      circleUrl:
        'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png', //头像
      sizeList: ['large'],
      tableData: [
        {
          date: '2016-05-03',
